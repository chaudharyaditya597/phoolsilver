...
const products = [
  { name: "PHOOL Pure Silver Vark Pack [30 Number]", image: "/30.png" },
  { name: "PHOOL Pure Silver Vark Pack [60 Number]", image: "/60.png" },
  { name: "PHOOL Pure Silver Vark Pack [90 Number]", image: "/90.png" },
  { name: "PHOOL Pure Silver Vark Pack [120 Number]", image: "/120.png" },
  { name: "PHOOL Commercial Manufacturer Pack", image: "/30.png" },
];
